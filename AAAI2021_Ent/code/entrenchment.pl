...
entrechmentA([Axiom|RestAs], FaultStateIn, EntStateTem, EntState, (T1,T2), TotalScores):-
    ...
    T1new is Ent1 + T1,
    T2new is Ent2 + T2,
    entrechmentA(RestAs, FaultStateIn, [EntAxiom| EntStateTem], EntState, (T1new, T2new), TotalScores).
